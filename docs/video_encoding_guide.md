...
| Color/DPR roadmap | descriptor + P3 + fit modes | `docs/proposals/completed/sizing_dpr_color.md` |
...
*See also:* `docs/proposals/completed/sizing_dpr_color.md` (fit modes, DPR, and the color descriptor
